...
[Given-When-Then](http://martinfowler.com/bliki/GivenWhenThen.html) is a style of writing tests where you describe the state of the code you want to test (`Given`). The behavioru you want to test (`When`) and the expected outcome (`Then`).
